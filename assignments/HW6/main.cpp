...
void preProcess(uchar4 **sourceImg, size_t &numRowsSource,
                size_t &numColsSource, uchar4 **destImg, uchar4 **blendedImg,
...
void your_blend(const uchar4 *const sourceImg, const size_t numRowsSource,
                const size_t numColsSource, const uchar4 *const destImg,
...
int main(int argc, char **argv) {
  ...
  preProcess(&h_sourceImg, numRowsSource, numColsSource, &h_destImg,
  ...
  your_blend(h_sourceImg, numRowsSource, numColsSource, h_destImg,
             h_blendedImg);
  ...
  reference_calc(h_sourceImg, numRowsSource, numColsSource, h_destImg,
                 h_reference);
