...
void computeIteration(const unsigned char *const dstImg,
                      ...
                      const size_t numColsSource, const float *const f,
                      const float *const g, float *const f_next) {
  unsigned int off =
...
void computeG(const unsigned char *const channel, float *const g,
...
void reference_calc(const uchar4 *const h_sourceImg, const size_t numRowsSource,
  ...
  for (size_t i = 0; i < numIterations; ++i) {
    computeIteration(blue_dst, strictInteriorPixels, borderPixels,
                     interiorPixelList, numColsSource, blendedValsBlue_1,
                     g_blue, blendedValsBlue_2);
  ...
  for (size_t i = 0; i < numIterations; ++i) {
    computeIteration(green_dst, strictInteriorPixels, borderPixels,
                     interiorPixelList, numColsSource, blendedValsGreen_1,
                     g_green, blendedValsGreen_2);
