...
void preProcess(unsigned int **inputVals, unsigned int **inputPos,
                ...
                size_t &numElems, const std::string &filename,
...
int main(int argc, char **argv) {
  ...
  preProcess(&inputVals, &inputPos, &outputVals, &outputPos, numElems,
  ...
  reference_calculation(&h_inputVals[0], &h_inputPos[0], &h_outputVals[0],
                        &h_outputPos[0], numElems);
